...
function init (client, d3) {
  ...
  function prepareArc (treatment, radius) {
    ...
    if (treatment.insulin > 0) {
      ...
      if (treatment.isSMB) { // don't show the unit of measurement for insulin boluses < 1 without carbs (e.g. oref0 SMB's). Otherwise lot's of small insulin only dosages are often unreadable
        unit_of_measurement = '';
